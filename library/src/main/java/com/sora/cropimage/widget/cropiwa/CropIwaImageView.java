...
import com.sora.cropimage.widget.cropiwa.util.MatrixAnimator;
import com.sora.cropimage.widget.cropiwa.util.MatrixUtils;
import com.sora.cropimage.widget.cropiwa.util.TensionInterpolator;
...
//        imageMatrix.postScale(0.3f, 0.3f, pivotX, pivotY);
        Log.d("postScale", "factor==" + factor);
